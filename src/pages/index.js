  ...
  return (
    <Layout>
      <article>
        ...
        <p className="entry-meta"><time datetime="2020-09-14">September 14, 2020</time>, by <Link to="#">Administrator</Link></p>
        ...
        <div className="entry-content">
          ...
          <div className="dm-player" cpeId="5df6e56e3e8c0962957f6a76" sort="recent" owners="kompastv" style={{'margin-bottom': '30px',}}></div>
